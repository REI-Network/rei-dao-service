...
// let currentBlock = 0;
// type subscriptionType = Subscription<BlockHeader> | Subscription<Log>;
// let subscriptionsResolve: undefined | ((value: subscriptionType[]) => void) =
//   undefined;
...
// const reSubscibeAllLoop = async () => {
//   while (1) {
//     const subscriptionList = await new Promise<subscriptionType[]>(
//       (resolve) => {
//         subscriptionsResolve = resolve;
//       }
//     );
...
// const changeSubscriptionsResolve = async () => {};
...
//   readState();
//   const subscriptionList: subscriptionType[] = [];
//   _startAfterSync(() => {});
